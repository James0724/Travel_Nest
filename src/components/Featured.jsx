      ...
      <section class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-10">
        <article class="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
          <div class="max-h-125 overflow-hidden">
            <Image
              ...
              src="/assets/image/featured/pexels-antony-trivet-6056773.jpg"
              alt=""
              width={400}
              height={500}
            />
        ...
        <article class="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
          <div class="max-h-125 overflow-hidden">
            <Image
              class="transform duration-300 group-hover:scale-110"
              src="/assets/image/featured/pexels-pixabay-259547.jpg"
              alt=""
              width={400}
              height={500}
            />
        ...
        <article class="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
          <div class="max-h-125 overflow-hidden">
            <img
              class="transform duration-300 group-hover:scale-110"
              src="/assets/image/featured/pexels-rachel-claire-4577837.jpg"
              alt=""
            />
          </div>
          <div class="flex justify-between my-5 ">
        ...
        <article class="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
          <div class="max-h-125 overflow-hidden">
            <img
              class="transform duration-300 group-hover:scale-110"
              src="/assets/image/featured/pexels-pixabay-34098.jpg"
              alt=""
            />
          </div>
          <div class="flex justify-between my-5 ">
        ...
        <article class="mx-auto pb-5 max-w-sm transform duration-500 hover:-translate-y-1 cursor-pointer group">
          <div class="max-h-125 overflow-hidden">
            <img
              class="transform duration-300 group-hover:scale-110"
              src="/assets/image/featured/pexels-pixabay-162313.jpg"
              alt=""
            />
          </div>
          <div class="flex justify-between my-5 ">
